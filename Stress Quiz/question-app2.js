function questionApp() {
  ...
  function finalScore() {
    ...
    wrapper.getElementById("div").innerHTML = finalScore;wrapper.getElementById("div").innerHTML = finalScore;
...
//      document.getElementById("button"+currentQuestion);
    ...
    button.addEventListener('click', function(){checkAnswer(selectedQuestion,questionSelect.value,currentButton);}, false);
  }
